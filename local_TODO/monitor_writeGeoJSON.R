...
#'
#' @description TODO:  Rewrite documentation to match new functionality!
#'
...
#' wa_current_geojson <- monitor_writeGeoJSON(wa, "wa_monitors.geojson")
