...
for (monitorID in c("060550003_01", "060950004_01", "060750005_01")){
  ...
  monitorMap(monitor, ylim = c(37.3, 38.9), xlim = c(-123.36, -121), cex = 0)
  ...
  monitorPlot_dailyBarplot(monitor, tlim = c(20171005, 20171025), ylim = c(0,200),  
