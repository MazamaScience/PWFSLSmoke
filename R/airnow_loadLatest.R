...
airnow_loadLatest <- function(baseUrl='https://haze.airfire.org/monitoring/RData/airnow_pm25_latest.RData') {
  
  # TODO:  Change to use baseUrl when that file starts getting created.
