...
#'
#' @title Apply Quality Control to raw AIRSIS EBAM PLUS_MULTI tibble
#'
...
#' @description Perform various QC measures on AIRSIS EBAM PLUS_MULTI data. This
#' data format began appearing in December, 2019 and is associated with data
#' available at https://apcd.airsis.com.
#'
...
airsis_EBAM_PLUS_MULTIQualityControl <- function(
  tbl,
  ...
  logger.debug(" ----- airsis_EBAM_PLUS_MULTIQualityControl() ----- ")

  # > names(tbl)
  # [1] "MasterTable_ID" "Alias"          "Latitude"       "Longitude"      "ConcRT.µg.m3."
  # [6] "ConcHR.µg.m3."  "Flow.lpm."      "WS.m.s."        "WD.Deg."        "AT.C."
  # [11] "RH..."          "BP.mmHg."       "FT.C."          "FRH..."         "BV.V."
  # [16] "PM"             "Status"         "TimeStamp"      "PDate"          "monitorName"
  # [21] "monitorType"    "monitorSubtype" "Date.Time.GMT"  "Sys..Volts"     "ConcHr"
  ...
  # # ----- Type ----------------------------------------------------------------
  #
  # NOTE:  Type was always "0" in first sample dataset apcd.1039
  #
