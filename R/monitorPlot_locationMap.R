...
#     addIcon(myMap, icon_paddle, lon, lat, expansion=iconExpansion_monitor, pos=3) #could build in icon expansion, or logic re: pos depending on icon type
#   } else {
#     addIcon(myMap, monitorIcon, lon, lat, expansion=iconExpansion_monitor, pos=0) #could build in icon expansion, or logic re: pos depending on icon type
#   }
#   
# }
# 
