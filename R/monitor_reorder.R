...
#' @return A ws_monitor object reordered to match \code{monitorIDs}.
#' @description This function is a convenience function that merely wraps the monitor_subset() function
