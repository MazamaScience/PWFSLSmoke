...
# #' @description Processes raw monitor data to create a consistent format that can be handled by various raw* functions. All original raw data is retained, and additional columns are added with names add consistently-named columns enabling processing from various sources.
