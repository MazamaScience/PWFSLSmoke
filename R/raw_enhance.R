...
#' @keywords raw_enhance
#' @export
#' @title Process Raw Monitoring Data to Create raw_enhanced Object
#' @param raw raw monitor data, as created by airsis_createRawDataframe or wrcc_createRawDataframe
#' @param rawSource source of raw monitor data (i.e. "AIRSIS" or "WRCC")
#' @description Processes raw monitor data to create a consistent format that can be handled by 
#' various raw* functions. All original raw data is retained, and additional columns are added 
#' with names add consistently-named columns enabling processing from various sources.
#' @return Dataframe with original raw data, plus new columns with uniform naming scheme for downstream use.
#' @examples 
#' \dontrun{
#'library(openair)
...
>>>>>>> 4d4f47a2c2b30af5688598ed95b6c9d2d3938273
