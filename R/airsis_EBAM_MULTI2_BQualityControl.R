...
#'
#' @title Apply Quality Control to raw AIRSIS EBAM MULTI2_B tibble
#'
...
airsis_EBAM_MULTI2_BQualityControl <- function(
  tbl,
  ...
  logger.debug(" ----- airsis_EBAM_MULTI2_BQualityControl() ----- ")

  # > names(tbl)
  # [1] "MasterTable_ID"           "Alias"                    "Latitude"
  # [4] "Longitude"                "Date.Time.GMT"            "ConcRT"
  # [7] "ConcHR"                   "ConcS.mg.m3."             "Flow"
  # [10] "W.S"                      "W.D"                      "AT"
  # [13] "RHx"                      "BP.mmHg."                 "RHi"
  # [16] "Oceaneering.Unit.Voltage" "FT"                       "Status"
  # [19] "Type"                     "BV"                       "TimeStamp"
  # [22] "PDate"                    "monitorName"              "monitorType"
  # [25] "monitorSubtype"           "Sys..Volts"
