...
mazamascience/pwfslsmoke          v1.0.7              c2403de11f34        About a minute ago   1.74GB
...
```
...
docker login
...
docker push mazamascience/pwfslsmoke:v1.0.7
```
...
```
docker pull mazamascience/pwfslsmoke:v1.0.7
```
