...
mazamascience/pwfslsmoke            1.2.100                 1824e396e3f3        34 seconds ago      2.61GB
...
docker login
...
docker push mazamascience/pwfslsmoke:1.2.100
```
...
```
docker pull mazamascience/pwfslsmoke:1.2.100
```
