...
Once a map is loaded, it can be plotted using `esriMap_plotOnStaticMap()`. This base plotting capabilities build into the `raster` package to plot the basemap. Now points and lines can be added using base R plotting functionality. 
